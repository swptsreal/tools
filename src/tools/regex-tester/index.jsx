...
export default function RegexTesterTool() {
    ...
    const actions = useMemo(() => <><Button icon={<Regex size={16} />} type="primary" onClick={run}>Test Regex</Button><Button icon={<Clipboard size={16} />} onClick={copy}>Copy</Button><Button icon={<Download size={16} />} onClick={() => downloadTextFile(output, 'regex-result.txt')}>Download</Button><RevertExample onClick={reset} /></>, [result])
